...
-- Proveedor / Producto
-- =======================
INSERT INTO Provedor (IdentificadorFiscal, NombreEmpresa, CorreoElectronico) VALUES
...
INSERT INTO Producto (Modelo, IdentificadorFiscalProvedor, Categoria, Precio, ExistenciasDisponibles) VALUES
...
INSERT INTO Producto (Modelo, IdentificadorFiscalProvedor, Categoria, Precio, ExistenciasDisponibles, Img) VALUES
    ('NR34', 98, 'Casual', 200, 5, 'nike/nike-white.png');

-- =======================
-- Sucursales
-- =======================
INSERT INTO Sucursal (Nombre, Direccion, NumeroTelefono) VALUES
...
-- Más sucursales internacionales (las dependencias no las usan aún, ok):
INSERT INTO Sucursal (Nombre, Direccion, NumeroTelefono) VALUES
...
-- =======================
-- Personas / Clientes / Empleados / Repartidores
-- =======================
...
INSERT INTO Cliente (CedulaCliente, Usuario, Contrasena) VALUES
    (208700187, 'HectorPro69', 'contraHectorSeguro'),
    (208700188, 'Juan13', 'juanxd'),
    (208700189, 'PedroCrack', 'contraDePedrito'),
    (208700190, 'MariaDB', 'MejorQueMySQL'),
    (208700191, 'Ana2', 'Ana123'),
    (208700192, 'Lusito', 'Comunica');

INSERT INTO Empleado (CedulaEmpleado, NumeroSucursalAsignada) VALUES
    (208700193, 1),
    (208700194, 2),
    (208700195, 3),
    (208700196, 4),
...
INSERT INTO Repartidor (CedulaRepartidor, NumeroSucursalAsignada) VALUES
    (208700199, 1),
    (208700200, 2),
    (208700201, 3),
    (208700202, 4),
...
-- =======================
-- Comentarios iniciales (AD5, EL2, etc.)
-- =======================
INSERT INTO Comentario (CedulaCliente, ModeloProducto, Estrellas, Comentario, Fecha, Hora) VALUES
...
-- =======================
-- Pedidos 1..6 y sus listas
-- =======================
INSERT INTO Pedido (CedulaCliente, FechaDeCompra) VALUES
...
INSERT INTO GarantiaXPedido (NumeroFacturaPedido, FechaInicio, FechaFinal, TipoGarantia) VALUES
...
-- Extra en lista 4
INSERT INTO ListaProductosPedidos (NumeroFacturaPedido, ModeloProducto, CantidadProducto)
VALUES (4, 'EL2', 2);

-- =======================
-- Más productos y updates de imágenes
-- =======================
UPDATE Comentario
SET Comentario = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla euismod libero nec sapien faucibus, nec consequat libero mollis.'
...
UPDATE Producto SET Img = 'adidas/adidas-dark-gray.png' WHERE Modelo = 'AD5';
UPDATE Producto SET Img = 'everlast/everlast-blue.png' WHERE Modelo = 'EL2';
UPDATE Producto SET Img = 'gap/gap-mint.png' WHERE Modelo = 'GP6';
UPDATE Producto SET Img = 'nike/nike-blue.png' WHERE Modelo = 'NR2';
UPDATE Producto SET Img = 'puma/puma-black.png' WHERE Modelo = 'PM12';
UPDATE Producto SET Img = 'under-armour/under-armour-militar.png' WHERE Modelo = 'UA34';
...
UPDATE Comentario SET Estrellas = 2 WHERE IdComentario = 8;
UPDATE Comentario SET Estrellas = 3 WHERE IdComentario = 9;

-- =======================
-- Más personas/cliente para empleados y repartidores
-- =======================
INSERT INTO Persona (Cedula, Nombre, PrimerApellido, SegundoApellido, Email) VALUES
...
-- Empleados y repartidores adicionales (requiere Sucursales 7..20 creadas):
INSERT INTO Empleado (CedulaEmpleado, NumeroSucursalAsignada) VALUES
    (208700219, 7),(208700220, 8),(208700221, 9),(208700222,10),(208700223,11),
    (208700224,12),(208700225,13),(208700226,14),(208700227,15),(208700228,16),
    (208700229,17),(208700230,18),(208700231,19),(208700232,20);
...
INSERT INTO Repartidor (CedulaRepartidor, NumeroSucursalAsignada) VALUES
    (208700233, 7),(208700234, 8),(208700235, 9),(208700236,10),(208700237,11),
    (208700238,12),(208700239,13),(208700240,14),(208700241,15),(208700242,16),
    (208700243,17),(208700244,18),(208700245,19),(208700246,20);

-- =======================
-- Más comentarios por producto
-- =======================
INSERT INTO Comentario (CedulaCliente, ModeloProducto, Estrellas, Comentario, Fecha, Hora) VALUES
...
-- =======================
-- Más pedidos/líneas/envíos 7..18
-- =======================
INSERT INTO Pedido (CedulaCliente, FechaDeCompra) VALUES
...
-- =======================
-- Más operaciones varias
-- =======================
INSERT INTO Persona (Cedula, Nombre, PrimerApellido, SegundoApellido, Email)
VALUES (108403221, 'Olivier', 'Giroud', 'Leao', 'email@example.com');

INSERT INTO Empleado (CedulaEmpleado, NumeroSucursalAsignada)
VALUES (108403221, 7);

-- Imágenes y Google Maps por sucursal (con BD activa IconicCaps)
UPDATE Sucursal SET Img='san-jose.png'    WHERE Nombre='Iconic San Jose';
UPDATE Sucursal SET Img='atlanta.png'     WHERE Nombre='Iconic Atlanta';
UPDATE Sucursal SET Img='barcelona.png'   WHERE Nombre='Iconic Barcelona';
UPDATE Sucursal SET Img='buenos-aires.png'WHERE Nombre='Iconic Buenos Aires';
UPDATE Sucursal SET Img='california.png'  WHERE Nombre='Iconic California';
UPDATE Sucursal SET Img='dubai.png'       WHERE Nombre='Iconic Dubai';
UPDATE Sucursal SET Img='hong-kong.png'   WHERE Nombre='Iconic Hong Kong';
UPDATE Sucursal SET Img='los-angeles.png' WHERE Nombre='Iconic Los Angeles';
UPDATE Sucursal SET Img='madrid.png'      WHERE Nombre='Iconic Madrid';
UPDATE Sucursal SET Img='manchester.png'  WHERE Nombre='Iconic Manchester';
UPDATE Sucursal SET Img='milan.png'       WHERE Nombre='Iconic Milan';
UPDATE Sucursal SET Img='new-york.png'    WHERE Nombre='Iconic New York';
UPDATE Sucursal SET Img='paris.png'       WHERE Nombre='Iconic Paris';
UPDATE Sucursal SET Img='roma.png'        WHERE Nombre='Iconic Rome';
UPDATE Sucursal SET Img='seattle.png'     WHERE Nombre='Iconic Seattle';
UPDATE Sucursal SET Img='singapore.png'   WHERE Nombre='Iconic Singapore';
UPDATE Sucursal SET Img='sydney.png'      WHERE Nombre='Iconic Sydney';
UPDATE Sucursal SET Img='tokyo.png'       WHERE Nombre='Iconic Tokyo';
UPDATE Sucursal SET Img='vienna.png'      WHERE Nombre='Iconic Vienna';
UPDATE Sucursal SET Img='zurich.png'      WHERE Nombre='Iconic Zurich';

UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/95HupBpJyGQ82i4BA'  WHERE Nombre='Iconic San Jose';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/q8Cfj6jK8jf6mXV47'  WHERE Nombre='Iconic Atlanta';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/k2SkhkT7Qe4tn4tA8'  WHERE Nombre='Iconic Barcelona';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/Lvzs5v5fHoqFzMN46'  WHERE Nombre='Iconic Buenos Aires';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/VbHBS82rH85VevhY8'  WHERE Nombre='Iconic California';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/H7F2GWi5ctwUx5Bi6'  WHERE Nombre='Iconic Dubai';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/st9g4w8GxMEDB5V16'  WHERE Nombre='Iconic Hong Kong';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/6sZs7w66VNYmgAt6A'  WHERE Nombre='Iconic Los Angeles';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/yF4evW1C6zai61zL9'  WHERE Nombre='Iconic Madrid';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/xAzS2FrqHyRmZ5ua7'  WHERE Nombre='Iconic Manchester';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/npAnWLUKKpWQFKv6A'  WHERE Nombre='Iconic Milan';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/nnk1QMF8GsAsW9hE7'  WHERE Nombre='Iconic New York';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/5kae4UhfrZtjv1gYA'  WHERE Nombre='Iconic Paris';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/suiE3UyVxJuprupw9'  WHERE Nombre='Iconic Rome';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/os21V9LQdL18FF747'  WHERE Nombre='Iconic Seattle';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/qHyxtbgY9fTt8DDm7'  WHERE Nombre='Iconic Singapore';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/U9mEJ4MqupdXQDd38'  WHERE Nombre='Iconic Sydney';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/NdbmQo9V6e8QvLjb7'  WHERE Nombre='Iconic Tokyo';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/5spJq9imTzcGcncB9'  WHERE Nombre='Iconic Vienna';
UPDATE Sucursal SET LinkGoogleMaps='https://maps.app.goo.gl/a3G99sWNAvjem2kv9'  WHERE Nombre='Iconic Zurich';

-- =======================
-- Operaciones adicionales finales
-- =======================
INSERT INTO ListaProductosPedidos (NumeroFacturaPedido, ModeloProducto, CantidadProducto) VALUES (4, 'AD5', 2);

INSERT INTO Pedido (CedulaCliente, FechaDeCompra) VALUES (208700190, NOW());
INSERT INTO ListaProductosPedidos (NumeroFacturaPedido, ModeloProducto, CantidadProducto) VALUES (19, 'AD5', 1);
INSERT INTO EnvioXPedido (NumeroFacturaPedido, CedulaRepartidor, Direccion, FechaEntrega, Estado)
VALUES (19, 208700243, 'Lorem ipsum...', NOW(), 'En proceso');
