    ...
    return (
        <div className="flex w-10/12 flex-col">
            <div className="flex w-full flex-row justify-between items-center">
                <div className="flex flex-row w-1/3 py-5 lg:py-0 lg:w-1/2 lg:space-x-10 xl:space-x-20">
                    <img src={props.imgSrc} alt={props.imgSrc} className="hidden w-1/4 lg:block md:w-1/4 xl:w-1/3"/>
